...
func runMigrations(db *sql.DB) error {
	...
	addColumnIfMissing(db, "usage_logs", "cache_write_5m_tokens", "INTEGER DEFAULT 0")
	addColumnIfMissing(db, "usage_logs", "cache_write_1h_tokens", "INTEGER DEFAULT 0")
	addColumnIfMissing(db, "usage_logs", "cache_read_tokens", "INTEGER DEFAULT 0")
	addColumnIfMissing(db, "usage_logs", "started_at", "DATETIME")
	addColumnIfMissing(db, "usage_logs", "completed_at", "DATETIME")
